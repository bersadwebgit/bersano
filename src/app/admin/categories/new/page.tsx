...
export default function NewCategoryPage() {
  ...
  // Compute hierarchical list of categories for the dropdown select
    ...
    <div className="max-w-2xl mx-auto pb-24">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white">افزودن دسته‌بندی جدید</h1>
        </div>
        <button
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  handleChange(e);
                  // Auto-generate slug if it's empty or user is typing name
                  if (!formData.slug || formData.slug === formData.name.replace(/\s+/g, '-').toLowerCase()) {
                    setFormData(prev => ({
                      ...prev,
                      name: e.target.value,
